...
func NewCORSFilter(allowed_origins []string) requestmodels.StrictMiddlewareFunc {

	var middleware = requestmodels.StrictMiddlewareFunc(func(handler requestmodels.StrictHandlerFunc, 
